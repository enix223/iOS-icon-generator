...
if __name__ == '__main__':
    ...
    print('Generating icon for ipad 1x...')
    gen_ipad_1x(sys.argv[1], sys.argv[2], prefix)
    print('Generating icon for ipad 2x...')
    gen_ipad_2x(sys.argv[1], sys.argv[2], prefix)
    print('Generating icon for iphone 2x...')
    gen_iphone_2x(sys.argv[1], sys.argv[2], prefix)
    print('Generating icon for iphone 3x...')
    gen_iphone_3x(sys.argv[1], sys.argv[2], prefix)
    print('Generating icon for ipad pro 2x...')
